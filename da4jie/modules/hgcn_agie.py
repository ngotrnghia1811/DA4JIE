...
class AGIE_HierachicalGCN(nn.Module):
    """
    #NOTE: For FourIE
    ...
    def __init__(self, args, num_types, config=None):
        super(AGIE_HierachicalGCN, self).__init__()
        self.args = args
    ...
    def get_task_specific_reps(self, gcn_input, predict):
        ...
        #NEW:
        lent_reprs = gcn_input['lent_ci_pooled'].N
        ...
        #NEW:
        ltrig_reprs = gcn_input['ltrig_ci_pooled'].N
        ...
        if self.config.grda and not predict:
            ...
            uent_reprs = gcn_input['uent_ci_pooled'].N
            ...
            utrig_reprs = gcn_input['utrig_ci_pooled'].N
