...
def score_graphs(logger, gold_graphs, pred_graphs,
    ...
    print('-----------\nAverage(entity, trigger, relation, role) F: {:.2f}'.format(
        (entity_f + trigger_f + relation_f + role_f) / 4. * 100.))
    logger.info('Entity: P: {:.2f}, R: {:.2f}, F: {:.2f}'.format(
        entity_prec * 100.0, entity_rec * 100.0, entity_f * 100.0))
    logger.info('Mention: P: {:.2f}, R: {:.2f}, F: {:.2f}'.format(
        mention_prec * 100.0, mention_rec * 100.0, mention_f * 100.0))
    logger.info('Trigger identification: P: {:.2f}, R: {:.2f}, F: {:.2f}'.format(
        trigger_id_prec * 100.0, trigger_id_rec * 100.0, trigger_id_f * 100.0))
    logger.info('Trigger: P: {:.2f}, R: {:.2f}, F: {:.2f}'.format(
        trigger_prec * 100.0, trigger_rec * 100.0, trigger_f * 100.0))
    logger.info('Relation: P: {:.2f}, R: {:.2f}, F: {:.2f}'.format(
        relation_prec * 100.0, relation_rec * 100.0, relation_f * 100.0))
    logger.info('Role identification: P: {:.2f}, R: {:.2f}, F: {:.2f}'.format(
        role_id_prec * 100.0, role_id_rec * 100.0, role_id_f * 100.0))
    logger.info('Role: P: {:.2f}, R: {:.2f}, F: {:.2f}'.format(
        role_prec * 100.0, role_rec * 100.0, role_f * 100.0))
    logger.info('-----------\nAverage(entity, trigger, relation, role) F: {:.2f}'.format(
        (entity_f + trigger_f + relation_f + role_f) / 4. * 100.))
    scores = {
